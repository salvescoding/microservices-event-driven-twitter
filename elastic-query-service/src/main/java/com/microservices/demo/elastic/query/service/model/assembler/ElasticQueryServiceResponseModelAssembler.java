...
public class ElasticQueryServiceResponseModelAssembler
    ...
    private final ElasticToQueryTransformer elasticToResponseModelTransformer;

    public ElasticQueryServiceResponseModelAssembler(ElasticToQueryTransformer transformer) {
