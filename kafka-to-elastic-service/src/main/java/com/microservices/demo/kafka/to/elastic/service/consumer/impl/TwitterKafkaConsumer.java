...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public void receive(@Payload List<TwitterAvroModel> messages,
        ...
        List<String> result = elasticIndexClient.save(avroToElasticModelTransformer.getElasticModels(messages));
        LOG.info("Documents saved to elasticsearch with ids {}", result.toArray());
